...
2. **Docs-First Guardrail**: The AI is forbidden from editing `src/` without first verifying or updating the corresponding root-level Spec.
...
- **The Code (`src/`)**: The "Implemented" layer. Contains the *how*.
